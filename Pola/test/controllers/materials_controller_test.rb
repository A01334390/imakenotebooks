...
class MaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material" do
    assert_difference('Material.count') do
      post materials_url, params: { material: { cantidad: @material.cantidad, nombre: @material.nombre } }
    end
  ...
  test "should update material" do
    patch material_url(@material), params: { material: { cantidad: @material.cantidad, nombre: @material.nombre } }
